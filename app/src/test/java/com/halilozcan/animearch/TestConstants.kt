...
import com.halilozcan.animearch.data.dto.single.ImagesX
import com.halilozcan.animearch.data.dto.single.SingleCharacterResponse
import com.halilozcan.animearch.data.dto.single.WebpX
...
val topAnimeCharacterResponse =
    TopAnimeCharacterResponse(data = listOf(topAnime), pagination = null)

@VisibleForTesting
val singleAnimeCharacterResponse = SingleCharacterResponse(data = singleAnime)
